...
export type TimelineAddEntries = {
  type: "TimelineAddEntries";
  entries: (TimelineItem | TimelineCursor | TimelineModule)[];
};

export type TimelineTerminateTimeline = {
...
export type FaceGeometry = { x: number; y: number; h: number; w: number };

export type MediaSize = { h: number; w: number; resize: "fit" | "crop" };
